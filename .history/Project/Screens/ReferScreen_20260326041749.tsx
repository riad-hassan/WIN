...
const icon = [
  { id: "1", name: "DIREXT REFERRALS", icon: "facebook", color: "#0a33e9ff", text:"00"},
  { id: "2", name: "TOTAL EARNINGS", icon: "local-phone", color: "#273b31ff", text:"$0.00" },
  { id: "3", name: "DIREXT REFERRALS", icon: "telegram", color: "#245372ff", text:"00"},
  { id: "4", name: "TOTAL EARNINGS", icon: "snapchat", color: "#0051ffff", text:"$0.00" },
];
