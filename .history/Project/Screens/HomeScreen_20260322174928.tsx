...
amount = amount - Math.floor(Math.random()*1500)
...
const [topPlayers,setTopPlayers] = useState(generatePlayers())
...
<View> 
             <View style={styles.container3}>
                <Swiper autoplay loop showsPagination={true} dotColor="#fff">
      ...
      >
        📢 Welcome to Grand WIN BET 🎉  Grand WIN BET এ রয়েছে নানা ধরনের অফার, সাথে পাচ্ছেন প্রতিদিন জেকপট জিতার সুযোগ।
      </Animated.Text>
            </View>
...
<Text style={styles.playerWin}>
💰 {player.win.toLocaleString()} Tk
</Text>
