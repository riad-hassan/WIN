...
import { ActivityIndicator,ToastAndroid, Image, KeyboardAvoidingView, ScrollView, StyleSheet, Text, TextInput, TouchableOpacity, View } from "react-native";
        ...
        <LinearGradient colors={["#e0f7fa", "#f3e5f5"]}>
          ...
          INVITE & EARN
            ...
            <View style={styles.container1}>
                ...
                <TouchableOpacity onPress={() => copyToClipboard(links.telegram)} style={styles.linkItem}>
          <MaterialIcons name="telegram" size={28} color="#0088cc" />
          <Text style={styles.linkText}>🔗 {links.telegram}</Text>
        </TouchableOpacity>
...
linkText: { fontSize: 18, fontWeight: "500", marginLeft: 10 },
