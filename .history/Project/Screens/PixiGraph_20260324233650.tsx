...
// ---------- CRUISE ----------
  ...
  const curveStrength = 90

  let curveY = baseY - Math.pow(multiplier, 2.3) * curveStrength
  y = Math.max(60, curveY)

  // 🔥 নতুন point (right side)
  const newX = app.screen.width * 0.75
  points.push({ x: newX, y })

  // ✅ plane fixed (important)
  plane.x = app.screen.width * 0.7
  plane.y = 80
