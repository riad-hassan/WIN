...
const handleSelectGateway = (item) => {
  ...
  if (item.name === "bKash") {
    navigation.navigate("BkashScreen", { data: item });
  } 
  else if (item.name === "Nagad") {
    navigation.navigate("NagadScreen", { data: item });
  } 
  else if (item.name === "Rocket") {
    navigation.navigate("RocketScreen", { data: item });
  } 
  else if (item.name === "Upay") {
    navigation.navigate("UpayScreen", { data: item });
  }
};
