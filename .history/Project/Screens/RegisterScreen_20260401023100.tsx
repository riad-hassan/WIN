...
const handleRegister = async () => {
  ...
  let finalReferral = referral.trim(); // clean spaces

  if (finalReferral) {
    // 🔥 Check if referral is valid agent
    ...
    // 🔹 No referral provided, assign default admin/system UID
    finalReferral = "ADMIN_UID_HERE"; // <-- এখানে ডিফল্ট অ্যাডমিন UID বসাও
  }
  ...
  const { error } = await supabase.from("users").insert([
    {
      ...
      password: pass,
      referral: finalReferral, // ✅ agent বা default admin
    },
  ]);
