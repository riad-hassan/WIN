...
const games = [ 
    ...
    { id: "82", title: "HIGH FLYER", image: require("../Screens/assets/high flyer.png"), action: "popup" },
    { id: "83", title: "SWORD OF KING", image: require("../Screens/assets/sword of king.png"), action: "popup", },  // popup er oikany screen dile oi screen open hby
    { id: "84", title: "POKER WIN", image: require("../Screens/assets/poker win.png"), action: "popup" }, 
    { id: "85", title: "CRAZY PUSHER", image: require("../Screens/assets/crazy pusher.png"), action: "popup" }, 
    { id: "86", title: "TWIN WINS", image: require("../Screens/assets/twin wins.png"), action: "popup" }, 
    { id: "87", title: "BOOK OF GOLD", image: require("../Screens/assets/book of gold.png"), action: "popup" }, 
    { id: "88", title: "VAULT RUSH", image: require("../Screens/assets/vault rush.png"), action: "popup" }, 
    { id: "89", title: "BANG BANG", image: require("../Screens/assets/jungle bang bang.png"), action: "popup" }, 
    { id: "90", title: "PERFECT CATCH", image: require("../Screens/assets/perfect catch.png"), action: "popup" }, 
    { id: "90", title: "MINES GAME", image: require("../Screens/assets/mins game.png"), action: "popup" },
    { id: "92", title: "BINGO ROLL", image: require("../Screens/assets/bingo roll (1).png"), action: "popup", },  // popup er oikany screen dile oi screen open hby
    { id: "93", title: "EGYPTIAN MINES", image: require("../Screens/assets/egyptian mines (1).png"), action: "popup" }, 
    { id: "94", title: "LADDER GAME", image: require("../Screens/assets/ladder game (1).png"), action: "popup" }, 
    { id: "95", title: "HEIST", image: require("../Screens/assets/heist (1).png"), action: "popup" }, 
    { id: "96", title: "TREADMILL RACING", image: require("../Screens/assets/treadmil racing (1).png"), action: "popup" }, 
    { id: "97", title: "ANIMAL RACE", image: require("../Screens/assets/animal race (1).png"), action: "popup" }, 
    { id: "98", title: "FanTan", image: require("../Screens/assets/fan tan (1).png"), action: "popup" }, 
    { id: "99", title: "HOUND RACING", image: require("../Screens/assets/hound racing (1).png"), action: "popup" }, 
    { id: "100", title: "BICHO", image: require("../Screens/assets/bicho (1).png"), action: "popup" }, 
    { id: "101", title: "Xoc Dia", image: require("../Screens/assets/xoc dia (1).png"), action: "popup" }, 
    { id: "102", title: "OAN TUTI", image: require("../Screens/assets/oan tuti (2).png"), action: "popup" }, 
    { id: "103", title: "FISH PRAWN CRAB", image: require("../Screens/assets/fish prawn crab.png"), action: "popup",},  // popup er oikany screen dile oi screen open hby
    { id: "104", title: "BLACK JACK", image: require("../Screens/assets/black jack.png"), action: "popup" }, 
    { id: "105", title: "BJ LUCKY LADIES", image: require("../Screens/assets/black jack lucky.png"), action: "popup" }, 
    { id: "106", title: "PussY go", image: require("../Screens/assets/pussy go.png"), action: "popup" }, 
    { id: "107", title: "VIDEO POKER", image: require("../Screens/assets/video poker.png"), action: "popup" }, 
    { id: "108", title: "MINE SWEEPER", image: require("../Screens/assets/mine sweeper.png"), action: "popup" }, 
    { id: "109", title: "TEEN PAATY", image: require("../Screens/assets/teen patty.png"), action: "popup" }, 
    { id: "110", title: "CASH ROCKET", image: require("../Screens/assets/cash rocket.png"), action: "popup" },
    { id: "111", title: "13 KILLER", image: require("../Screens/assets/13 killer.png"), action: "popup", },  // popup er oikany screen dile oi screen open hby
    { id: "112", title: "TANGKAS", image: require("../Screens/assets/bola tangkas.png"), action: "popup" }, 
];
