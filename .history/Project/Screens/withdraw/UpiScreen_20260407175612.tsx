...
export default function WupiScreen() {
...
const [loading, setLoading] = useState(false);
  ...
  if (numAmount < 1000) return Alert.alert("Minimum", "সর্বনিম্ন ১,০০০ INR দিতে হবে");
  if (numAmount > balance) return Alert.alert("Error", "Insufficient Balance");
  if (!number) return Alert.alert("Error", "UPI ID দিন");
  if (number.length < 11) return Alert.alert("Error", "Valid UPI ID দিন");
