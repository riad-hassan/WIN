...
const bottomMenuItems = [
 ...
 const renderIcon = (item) => (
  ...
  const games = [ 
    ...
    { id: "61", title: "AVIATOR GAME", image: require("../Screens/assets/aviator.png"), action: "screen", screen: "AVIATOR GAME" },  // popup er oikany screen dile oi screen open hby
    { id: "62", title: "ANDAR & BAHAR", image: require("../Screens/assets/andar bahar (1).png"), action: "popup" }, 
    { id: "63", title: "PLINKO GAME", image: require("../Screens/assets/pling.png"), action: "popup" }, 
    { id: "64", title: "CRAZY TIME", image: require("../Screens/assets/crazy_time.png"), action: "popup" }, 
    { id: "65", title: "DRAGON VS TIGER", image: require("../Screens/assets/lion vs tiger.png"), action: "popup" }, 
    { id: "66", title: "3 PATTI", image: require("../Screens/assets/3patti (1).png"), action: "popup" }, 
    { id: "67", title: "777", image: require("../Screens/assets/777 (1).png"), action: "popup" }, 
    { id: "68", title: "CRAZY-777", image: require("../Screens/assets/crazy-777 (1).png"), action: "popup" }, 
    { id: "69", title: "HELICOPTER", image: require("../Screens/assets/helicopter.png"), action: "popup" }, 
    { id: "70", title: "JILI", image: require("../Screens/assets/jili.png"), action: "popup" }, 
    { id: "71", title: "SuperAce", image: require("../Screens/assets/superace.png"), action: "popup" }, 
    { id: "72", title: "COIN TOSS", image: require("../Screens/assets/Coin-Toss.png"), action: "popup",},  // popup er oikany screen dile oi screen open hby
    { id: "73", title: "Mega Ace", image: require("../Screens/assets/mega ace.png"), action: "popup" }, 
    { id: "74", title: "BOXING KING", image: require("../Screens/assets/Boxing.png"), action: "popup" }, 
    { id: "75", title: "GOLDEN TREASURE", image: require("../Screens/assets/golden.png"), action: "popup" }, 
    { id: "76", title: "CHIKEN ROAD", image: require("../Screens/assets/chiken.png"), action: "popup" }, 
    { id: "77", title: "7UP 7DOWN", image: require("../Screens/assets/7-Up-7-Down.png"), action: "popup" }, 
    { id: "78", title: "CHICKY RUN", image: require("../Screens/assets/chicky-run.png"), action: "popup" }, 
    { id: "79", title: "POKER KINGDOM", image: require("../Screens/assets/Poker_Kingdom.png"), action: "popup" },
    { id: "80", title: "LUCKY FORTUNES", image: require("../Screens/assets/luckyf.png"), action: "popup", },  // popup er oikany screen dile oi screen open hby
    { id: "81", title: "GOLDEN TIME", image: require("../Screens/assets/golden.png"), action: "popup" }, 
