...
headerRight:()=> <CasinoHeader/>
            ...
            options={{
                headerStyle: {backgroundColor: '#5dbbabff'},
                headerShown: true,
        ...
        <Image
          ...
          style={{ width: 120, height: 40, resizeMode: 'contain', marginLeft:-40 }}
        />
        <Text style={{fontSize:20, fontWeight: '900', marginLeft: -32, marginTop:8}} >GRAND WIN</Text>
