...
headerRight:()=> <CasinoHeader/>
        ...
        <Image
          ...
          style={{ width: 160, height: 47, resizeMode: 'contain', marginLeft:-60, borderRadius:15 }}
        />
        <Text style={{fontSize:20, fontWeight: '900', marginLeft: -52, marginTop:8}} >GRAND WIN</Text>
