...
export default function NagadScreen({ route, navigation }) {
...
const { depositId } = route.params; 
  ...
  const quickAmounts = [500, 1000, 2000, 5000, 10000, 20000];
   ...
   const handleContinue = async () => {
      ...
      if (error) {
        console.log("NagadScreen update error:", error.message);
      }
  
      navigation.navigate("NagadConfirm", { depositId, amount });
    };
