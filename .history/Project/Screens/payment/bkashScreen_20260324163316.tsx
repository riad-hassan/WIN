...
export default function BkashScreen() {
  ...
  const handleContinue = () => {
    ...
    if (num < 300) {
      Alert.alert("Minimum", "সর্বনিম্ন ৩০০ টাকা দিতে হবে");
      return;
    }

    Alert.alert("Success", `আপনি ৳${amount} জমা দিচ্ছেন`);
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.logo}>SK444</Text>
      ...
      {/* BONUS */}
      <Text style={styles.bonus}>+10% bonus</Text>
