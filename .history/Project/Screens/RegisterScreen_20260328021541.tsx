  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={styles.tabBox}>
        <TouchableOpacity
          style={[styles.tabBtn, tab === "email" && styles.activeTab]}
        ...
        >
          ...
          <Text style={[styles.tabText, { color: "#111827" }]}> Phone</Text>
        </TouchableOpacity>
      </View>
      ...
      <Text style={styles.loginText}>
        ...
        <Text style={{ color: "#facc15", fontWeight: "bold" }}>Login</Text>
      </Text>
    </View>
    </ScrollView>
  );
