...
const vanishX = app.screen.width * 0.5
const vanishY = app.screen.height   // 👈 নিচে converge point

for(let i=-200;i<app.screen.width+200;i+=40){

  let x = i + (gridOffsetX % 40)

  grid.moveTo(x, 0)
  grid.lineTo(vanishX, vanishY)   // 👈 সব লাইন নিচে গিয়ে মিলবে
}
