...
{ id: "34", title: "ANDAR & BAHAR", image: require("../Screens/assets/andar bahar (1).png"), action: "popup" }, 
    { id: "35", title: "PLINKO GAME", image: require("../Screens/assets/pling.png"), action: "popup" }, 
    { id: "36", title: "CRAZY TIME", image: require("../Screens/assets/crazy_time.png"), action: "popup" }, 
    { id: "37", title: "DRAGON VS TIGER", image: require("../Screens/assets/lion vs tiger.png"), action: "popup" }, 
    { id: "38", title: "3 PATTI", image: require("../Screens/assets/3patti (1).png"), action: "popup" }, 
    { id: "39", title: "777", image: require("../Screens/assets/777 (1).png"), action: "popup" }, 
    { id: "40", title: "CRAZY-777", image: require("../Screens/assets/crazy-777 (1).png"), action: "popup" }, 
    { id: "41", title: "HELICOPTER", image: require("../Screens/assets/helicopter.png"), action: "popup" }, 
    { id: "42", title: "JILI", image: require("../Screens/assets/jili.png"), action: "popup" }, 
    { id: "43", title: "SuperAce", image: require("../Screens/assets/superace.png"), action: "popup" }, 
    { id: "44", title: "COIN TOSS", image: require("../Screens/assets/Coin-Toss.png"), action: "popup",},  // popup er oikany screen dile oi screen open hby
    { id: "45", title: "Mega Ace", image: require("../Screens/assets/mega ace.png"), action: "popup" }, 
    { id: "46", title: "BOXING KING", image: require("../Screens/assets/Boxing.png"), action: "popup" }, 
    { id: "47", title: "GOLDEN TREASURE", image: require("../Screens/assets/golden.png"), action: "popup" }, 
    { id: "48", title: "CHIKEN ROAD", image: require("../Screens/assets/chiken.png"), action: "popup" }, 
    { id: "49", title: "7UP 7DOWN", image: require("../Screens/assets/7-Up-7-Down.png"), action: "popup" }, 
    { id: "50", title: "CHICKY RUN", image: require("../Screens/assets/chicky-run.png"), action: "popup" }, 
    { id: "51", title: "POKER KINGDOM", image: require("../Screens/assets/Poker_Kingdom.png"), action: "popup" },
    { id: "52", title: "LUCKY FORTUNES", image: require("../Screens/assets/luckyf.png"), action: "popup", },  // popup er oikany screen dile oi screen open hby
    { id: "53", title: "GOLDEN TIME", image: require("../Screens/assets/golden.png"), action: "popup" }, 
    { id: "54", title: "POKER GAME", image: require("../Screens/assets/Poker_Kingdom.png"), action: "popup" }, 
    { id: "55", title: "PINK JOKER", image: require("../Screens/assets/pink.png"), action: "popup" }, 
    { id: "56", title: "LUDO BOARD", image: require("../Screens/assets/Ludo Board.png"), action: "popup" }, 
    { id: "57", title: "BG LIVE", image: require("../Screens/assets/BG.png"), action: "popup" }, 
