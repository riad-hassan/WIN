  ...
  const loadPayment = async () => {
    try {
      ...
      if (saved) {
        ...
        // saved number গুলো state এ রাখো
...
const selectGateway = (method) => {
  ...
  // auto number set
  if (savedNumbers[method]) {
    setNumber(savedNumbers[method]);
  } else {
    setNumber("");
  }
};
    ...
    return(
        <ScrollView>
           <View style={styles.container}>
            ...
            <TextInput style={styles.input} value={number} onChangeText={setNumber} placeholder="  e.g 01XXXXXXXXX" keyboardType="numeric" />
...
const styles = StyleSheet.create ({
  ...
  gatewayLabel: { marginTop: 5, fontWeight: "500", color: "#066124ff" },
