...
const [,setHistory] = useState(generateRealisticHistory()) 
const generateInitialPlayers = () => {
  ...
  for (let i = 0; i < 12; i++) {
    ...
    const betAmount = [500, 1000, 2500, 5000, 8000][Math.floor(Math.random() * 5)];
...
setPlayers(prev => {
  ...
  return [newItem, ...prev].slice(0, 50); // 🔥 keep list growing
});
