...
export default function GameDetailsScreen({ route, navigation }) {
  ...
  const avatorWinners = Array.from({ length: 100 }, (_, i) => ({
    name: `"Rahim332","Karim43","Hasan5g","Sakiber4","Nayeemt54", "Moli", "Aktar354", "Jenijd", "gShofiq", "Soh...", "Barsha", "Abir", "Tahsin", "mehrab", "Rohan", "Naomi", "Maaryam", "mahin", "jahid", "	MAHDI", "Ridwan", "Shah", "Hridi", "Sanjana", "Saeed", "Protik",
