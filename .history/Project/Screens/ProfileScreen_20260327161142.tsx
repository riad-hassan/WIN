  ...
  useCallback(() => {
    const loadKycStatus = async () => {
      ...
      if (savedStatus === "Verified") {
        setProgress(1); // 100%
        setLevelText("Level 2 of 2");
      } else {
        setProgress(0); // 0%
        setLevelText("Level 1 of 2");
      }

      // 🔥 Balance progress
      if (balance > 0) {
        const perc = Math.min(balance / maxBalance, 1); // 0–1
        setBalanceProgress(perc);
      }
    };
...
<Text
    ...
    <View style={styles.infoRow}>
      <Text style={styles.infoValue} numberOfLines={1}>
  Number:  {kycNumber ? kycNumber : "Not Set"}
</Text>
    </View>
...
{/* ✅ এখানে বসাও KYC & Balance Progress */}
<LinearGradient
  colors={["#1e293b", "#0f172a"]}
  style={styles.card}
>
  <Text style={{color:"#fff"}}>{levelText}</Text>
  <View style={styles.progressBg}>
    <View style={[styles.progressFill, { width: progress === 1 ? "100%" : "0%" }]} />
  </View>
</LinearGradient>

<View style={{marginHorizontal: 20, marginTop: 20}}>
  <Text style={{fontWeight:"700"}}>Balance Progress</Text>
  <View style={{height: 12, backgroundColor:"#ccc", borderRadius:6, marginTop:6}}>
    <Animated.View
      style={{
        height: 12,
        borderRadius:6,
        backgroundColor:"#22c55e",
        width: balanceProgress * 100 + "%" // 0–100%
      }}
    />
  </View>
  <Text>{`৳${balance.toFixed(2)} / ৳${maxBalance}`}</Text>
</View>
    ...
    >
      ...
      <View style={styles.topRow}>
        ...
        <View>
          <Text style={styles.percent}>{progress === 1 ? "100%" : "0%"}</Text>
      ...
      <View style={styles.stepsRow}>
        ...
        <View style={styles.activeStep}>
          ...
          <Text style={styles.activeText}>Basic</Text>
        </View>
        ...
        <View style={styles.step}>
          ...
          <Text style={styles.stepText}>Funds</Text>
        </View>
