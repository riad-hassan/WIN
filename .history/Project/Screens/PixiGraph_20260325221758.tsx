...
// ---------- CRUISE ----------
  ...
  // 🔥 LIMIT growth (main fix)
  let limitedT = Math.min(t, 3.5)

  // smooth curve
  let curve = Math.pow(limitedT, 1.4)

  // extra slow after 4x
  let slowFactor = 1 + Math.max(0, t - 3.5) * 0.3

  y = lastY - (curve * 5) / slowFactor

  // hard limit (screen er baire jabe na)
  y = Math.max(50, y)
