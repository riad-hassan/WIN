...
const handleLogout = async () => {
  try {
    ...
    if (onLogout) onLogout(); // 🔥 setIsLoggedIn(false) call হবে
...
// অ্যাপ লোড হলে AsyncStorage থেকে নাম্বার ও মেথড নিয়ে আসা
  ...
  <View style={styles.avatarBox}>
    ...
    >
      <Text style={{ color: "#f5ed7dff", fontSize: 12 }}>✏️</Text>
    </TouchableOpacity>
  </View>
...
<Text
    ...
    <View style={styles.infoRow}>
      ...
      <Text style={styles.infoValue}>          {uid}</Text>
    </View>
  ...
  Number:  {kycNumber ? kycNumber : "Not Set"}
        ...
        <View style={styles.infoBox}>
          <View style={styles.row1}>
            ...
            <MaterialIcons name="account-balance-wallet" size={20} color="#daf103ff" />
          </View>
        ...
        <View style={styles.bottomContainer}>
          {bottomMenuItems.map((item) => (
            <TouchableOpacity 
               ...
               >
              <MaterialIcons name={item.icon} size={40} color="#f3facbff" />
    ...
    >
      ...
      <View style={styles.row}>
        ...
        <View style={styles.item}>
          ...
          <Text style={styles.value2}>0%</Text>
        ...
        <View style={styles.item}>
          ...
          <Text style={[styles.value2, { color: "#fff" }]}>৳50K</Text>
