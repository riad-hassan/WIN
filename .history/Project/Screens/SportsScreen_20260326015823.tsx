...
const games = [ 
    ...
    { id: "103", title: "ROULETTE RUSSIA", image: require("../Screens/assets/roulette russia.png"), action: "popup",},  // popup er oikany screen dile oi screen open hby
    { id: "104", title: "BAC BO", image: require("../Screens/assets/bac bo.png"), action: "popup" }, 
    { id: "105", title: "BACCARAT PRO", image: require("../Screens/assets/baccarat pro.png"), action: "popup" }, 
    { id: "106", title: "HIT THE GOLD", image: require("../Screens/assets/hit the gold.png"), action: "popup" }, 
    { id: "107", title: "TRAIN OF GOLD", image: require("../Screens/assets/train of gold.png"), action: "popup" }, 
    { id: "108", title: "PYRAMD COINS", image: require("../Screens/assets/pyramid coins.png"), action: "popup" }, 
    { id: "109", title: "CRICKET X", image: require("../Screens/assets/cricket x.png"), action: "popup" }, 
    { id: "110", title: "GEMS OF RA", image: require("../Screens/assets/gems of ra.png"), action: "popup" },
    { id: "111", title: "BACCARAT", image: require("../Screens/assets/baccarat.png"), action: "popup", },  // popup er oikany screen dile oi screen open hby
    { id: "112", title: "AZURE ROULETTE", image: require("../Screens/assets/azure roulette.png"), action: "popup" }, 
