...
const gateways = [ 
    { id: "1", name: "bKash", image: require("../Screens/assets/bkash.png"),number: "qqqqqqqq", min: 500.00, max: 50000.00, currency: "৳", },  
...
if (!userId) return Alert.alert("Error", "User not logged in");
  ...
  else if (item.name === "Upi") navigation.navigate("Upi", { depositId });
};
