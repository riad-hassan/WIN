...
// অ্যাপ লোড হলে AsyncStorage থেকে নাম্বার ও মেথড নিয়ে আসা
  ...
  <View style={styles.profileInfo}>
    ...
    <View style={styles.infoRow}>
      ...
      <Text style={styles.infoValue} numberOfLines={1}>Rahim</Text>
    </View>
    ...
    <View style={styles.infoRow}>
      ...
      <Text style={styles.infoValue} numberOfLines={1}>017XXXXXXXX</Text>
    </View>
        ...
        >
          <MaterialIcons name="notifications-none" size={20} color="#21d69aff" />
