...
const names = [
"Rahim332","KKarim43","Hasan5g","Sakiber4","Nayeemt54", "Moli", "Aktar354", "Jenijd", "gShofiq", "Soh...", "Barsha", "Abir", "Tahsin", "mehrab", "Rohan", "Naomi", "Maaryam", "mahin", "jahid", "	MAHDI", "Ridwan", "Shah", "Hridi", "Sanjana", "Saeed", "Protik",
...
let amount = 180000
 ...
 return Array.from({ length: 10 }).map((_, i) => ({
    ...
    win: Math.floor(200000 + Math.random() * 5000000),
