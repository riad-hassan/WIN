...
bottomContainer: {
  flexDirection: "row",
  justifyContent: "space-between", // 🔹 flex space
  marginTop: 25,
  width: "94%",                   // 🔹 container width responsive
  alignSelf: "center",            // 🔹 center container
  flexWrap: "wrap",               // 🔹 ছোট ফোনে দুইটা লাইনেও যাবে
  gap: 10,                        // 🔹 flex gap (RN 0.71+)
},
bottomContainer2: {
  flexDirection: "row",
...
bottomCard: {
  ...
  minWidth: 150,         // 🔹 minimum width for small phones
  maxWidth: 170,         // 🔹 maximum width for big phones
  height: 130,
