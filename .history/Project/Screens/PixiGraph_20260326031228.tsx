...
app.ticker.add(() => {
  const glow = Math.sin(Date.now() * 0.008) * 10 + 25
  flewText.style.dropShadowBlur = glow
})
...
let displayMultiplier = multiplier * 1.15  // 🔥 feel fast

text.text = displayMultiplier.toFixed(2) + "x"
