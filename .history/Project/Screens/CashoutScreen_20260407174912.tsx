...
const gateways = [ 
    { id: "1", name: "bKash", image: require("../Screens/assets/bkash.png"),number: "qqqqqqqq", min: 1000, max: 100000, currency: "৳", },  
    { id: "2", name: "Nagad", image: require("../Screens/assets/nogod.png"), number: "eeeeee",min: 1000, max: 100000, currency: "৳", }, 
    { id: "3", name: "Rocket", image: require("../Screens/assets/rocket.png"), number: "00000000",min: 1000, max: 100000, currency: "৳",  }, 
    { id: "4", name: "Upay", image: require("../Screens/assets/upay.png"), number: "111111111",min: 1000, max: 100000, currency: "৳", },
    { id: "5", name: "UPI", image: require("../Screens/assets/upi (1).png"), number: "ppppppppp",min: 1000, max: 100000, currency: "₹",  },
];
...
const handleSelectGateway = (item) => {
  ...
  else if (item.name === "UPI") {
    navigation.navigate("Wupi", { data: item });
  }
};
...
const [username, setUsername] = useState(""); // AsyncStorage থেকে load 
useEffect(() => { 
        ...
        <Text style={styles.balanceText}>**{username}**</Text>
            ...
            {gateways.map((item) => (
              ...
              >
                ...
                <Text>
                  {item.currency}{item.min.toLocaleString()} - {item.currency}{item.max.toLocaleString()}
                </Text>
