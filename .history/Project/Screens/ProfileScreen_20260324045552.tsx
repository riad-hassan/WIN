...
// অ্যাপ লোড হলে AsyncStorage থেকে নাম্বার ও মেথড নিয়ে আসা
 ...
 {/* Payment Section */}
        ...
        <View style={styles.bottomContainer}>
          {bottomMenuItems.map((item) => (
            <TouchableOpacity 
               ...
               onPress={() => {
                if (item.name === "Wallet") navigation.navigate("HOT GAMES");
        ...
        <TouchableOpacity style={styles.btn1} >
          <MaterialIcons name="verified" size={20} color="#21d69aff" />
          <Text style={styles.btnText1}>  KYC Verification</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.btn1} >
          <MaterialIcons name="settings" size={20} color="#afa6a6ff" />
          <Text style={styles.btnText1}> Settings</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.btn1} >
          <MaterialIcons name="help-outline" size={20} color="#2673d8ff" />
