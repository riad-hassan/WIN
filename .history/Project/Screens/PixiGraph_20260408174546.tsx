...
// ---------- PLANE ----------
const texture = PIXI.Texture.from("https://i.ibb.co/rRnPGGCq/plane.png")
const plane = new PIXI.Sprite(texture)

plane.anchor.set(0.5)

// 🔥 original ratio ধরে height calculate
const ratio = texture.height / texture.width

plane.width = 90
plane.height = 90 * ratio
