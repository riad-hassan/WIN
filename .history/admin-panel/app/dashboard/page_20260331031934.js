...
const [refferLoading, setRefferLoading] = useState(false);
  ...
  const load = async () => {
    ...
    // ===== Load Help Contact Settings =====
const { data: helpRows, error: helpErr } = await supabase
  .from("Help Contact")
  .select("*");
...
// ================= HelpContact =================
const saveHelpContact = async () => {
  setHelpLoading(true);

  const updates = [
    { key: "whatsapp", value: helpData.whatsapp },
    { key: "telegram", value: helpData.telegram },
    { key: "facebook", value: helpData.facebook },
    { key: "support_number", value: helpData.support_number },
  ];
  ...
  alert("Help Contact Updated Successfully!");
  ...
  return (
    <div className="p-4 text-white">
      ...
      <div className="flex gap-2 mb-6 flex-wrap">
        {["dashboard","users","deposits","withdraw","payments","notify","helpcontact" ].map(t => (
          <button
            key={t}
            onClick={() => setTab(t)}
...
{/* ================= helpcontact ================= */}
  ...
  <div className="bg-gray-950 p-6 rounded-xl text-white max-w-3xl mx-auto shadow-lg border border-gray-800">
    <h2 className="text-2xl font-bold mb-2">Help Contact Settings</h2>
    <p className="text-gray-400 mb-6">
      Change support contact links. These will update everywhere in realtime.
    </p>
    ...
    <div className="grid gap-4">
      ...
      <div className="bg-gray-900 p-4 rounded-xl border border-gray-800">
        ...
        <input
          ...
          value={helpData.whatsapp}
          onChange={(e) =>
            setHelpData((prev) => ({ ...prev, whatsapp: e.target.value }))
          }
      ...
      <div className="bg-gray-900 p-4 rounded-xl border border-gray-800">
        ...
        <input
          ...
          value={helpData.telegram}
          onChange={(e) =>
            setHelpData((prev) => ({ ...prev, telegram: e.target.value }))
          }
      ...
      <div className="bg-gray-900 p-4 rounded-xl border border-gray-800">
        ...
        <input
          ...
          value={helpData.facebook}
          onChange={(e) =>
            setHelpData((prev) => ({ ...prev, facebook: e.target.value }))
          }
      ...
      <div className="bg-gray-900 p-4 rounded-xl border border-gray-800">
        ...
        <input
          ...
          value={helpData.support_number}
          onChange={(e) =>
            setHelpData((prev) => ({ ...prev, support_number: e.target.value }))
          }
      ...
      {/* Preview */}
      <div className="bg-gradient-to-r from-indigo-700 to-purple-700 p-5 rounded-xl shadow-lg">
        <h3 className="text-lg font-semibold mb-3">Live Preview</h3>

        <p className="text-gray-200 text-sm mb-1">
          WhatsApp: <span className="font-bold">{helpData.whatsapp || "-"}</span>
        </p>

        <p className="text-gray-200 text-sm mb-1">
          Telegram: <span className="font-bold">{helpData.telegram || "-"}</span>
        </p>

        <p className="text-gray-200 text-sm mb-1">
          Facebook: <span className="font-bold">{helpData.facebook || "-"}</span>
        </p>

        <p className="text-gray-200 text-sm">
          Support Number:{" "}
          <span className="font-bold">{helpData.support_number || "-"}</span>
        </p>
      </div>
      ...
      >
        {helpLoading ? "Saving..." : "Save Help Contact"}
      </button>
    </div>
  </div>
)}
