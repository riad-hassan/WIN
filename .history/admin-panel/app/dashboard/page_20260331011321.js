  ...
  return (
    <div className="p-4 text-white">
      ...
      <div className="grid gap-4">
        {users.map((u) => (
          <div key={u.id} className="bg-gray-900 p-5 rounded-xl shadow-lg border border-gray-700">
            ...
            <div className="grid grid-cols-2 gap-4 text-white">
              ...
              <div className="col-span-2">
                ...
                <input
                  ...
                  className="w-full p-2 rounded bg-gray-800 text-white border border-gray-600 mt-1"
                />
              </div>
            </div>
