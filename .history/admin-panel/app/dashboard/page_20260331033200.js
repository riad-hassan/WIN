...
// Load payments from Supabase
  ...
  <div className="space-y-6">
    ...
    {/* Header */}
    <div className="bg-gradient-to-r from-purple-700 to-indigo-700 p-6 rounded-2xl shadow-lg border border-gray-800">
      <h2 className="text-3xl font-bold text-white">Admin Dashboard</h2>
      <p className="text-gray-200 mt-1">
        Welcome back! Manage users, deposits, withdraw and system settings.
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="bg-gray-900 p-5 rounded-2xl border border-gray-800 shadow hover:shadow-xl transition">
        <p className="text-gray-400 text-sm">Total Users</p>
        <p className="text-3xl font-bold text-white mt-1">{users.length}</p>
        <p className="text-green-400 text-sm mt-2">Active System</p>
      </div>

      <div className="bg-gray-900 p-5 rounded-2xl border border-gray-800 shadow hover:shadow-xl transition">
        <p className="text-gray-400 text-sm">Total Deposits</p>
        <p className="text-3xl font-bold text-white mt-1">{deposits.length}</p>
        <p className="text-blue-400 text-sm mt-2">Requests received</p>
      </div>

      <div className="bg-gray-900 p-5 rounded-2xl border border-gray-800 shadow hover:shadow-xl transition">
        <p className="text-gray-400 text-sm">Total Withdraw Requests</p>
        <p className="text-3xl font-bold text-white mt-1">{withdraws.length}</p>
        <p className="text-yellow-400 text-sm mt-2">Pending approvals</p>
      </div>

      <div className="bg-gray-900 p-5 rounded-2xl border border-gray-800 shadow hover:shadow-xl transition">
        <p className="text-gray-400 text-sm">Payment Numbers</p>
        <p className="text-3xl font-bold text-white mt-1">{payments.length}</p>
        <p className="text-purple-400 text-sm mt-2">Manage payment methods</p>
      </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
      ...
      {/* Latest Deposits */}
      <div className="bg-gray-950 p-5 rounded-2xl border border-gray-800 shadow-lg">
          ...
          <div className="space-y-3">
            {deposits
              ...
              .map((d) => (
                <div
                  key={d.id}
                  className="flex justify-between items-center bg-gray-900 p-3 rounded-xl border border-gray-800"
                >
                  <div>
    ...
    <div className="bg-gray-950 p-6 rounded-2xl border border-gray-800 shadow-lg">
      ...
      <div className="flex flex-wrap gap-3">
        <button
          ...
          className="bg-blue-600 hover:bg-blue-700 transition px-4 py-2 rounded-xl font-semibold"
        >
          Manage Users
        </button>
        ...
        <button
          ...
          className="bg-yellow-600 hover:bg-yellow-700 transition px-4 py-2 rounded-xl font-semibold"
        >
          Withdraw Requests
        </button>
        ...
        <button
          ...
          className="bg-purple-600 hover:bg-purple-700 transition px-4 py-2 rounded-xl font-semibold"
        >
          Payment Settings
        </button>
