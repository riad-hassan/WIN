...
{tab === "withdraw" && (
  <div className="space-y-4">
    ...
    {withdraws.map((w) => (
      <div
        key={w.id}
        className="bg-gray-800 p-5 rounded-xl shadow-md border border-gray-700 hover:shadow-lg transition"
      >
        ...
        {w.status === "Pending" && (
          <div className="flex gap-2">
            ...
            <button
              ...
              className="flex-1 bg-red-500 hover:bg-red-600 transition text-white px-4 py-2 rounded-md font-semibold"
            >
              Reject
            </button>
          </div>
